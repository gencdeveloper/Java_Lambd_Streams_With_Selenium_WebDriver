...
import com.udemy.java.lambda.MultipleParameterForLambdaExample;
...
//        };
        ...
        GreetingService withoutParameterType = (name) -> System.out.println("Without Parameter type " + name.toUpperCase());
        ...
        //interface just with one Abstract method for multi line lambda
        MultipleParameterForLambdaExample getInformation = (name, LastName,Age)
                -> System.out.println("My Information::" + name.toUpperCase() +" "+LastName.toUpperCase()+" "+Age);

        //call it with variable name and interface abstractMethod
        getInformation.information("Emre","Ozudogru",30);
